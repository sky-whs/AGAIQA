...
[Link to the article](https://ieeexplore.ieee.org/document/10539107)
...
*(Insert network structure image here)*

## **USAGE**
python train.py

## **Acknowledgment**
Our codes partially borrowed from MANIQA [Link to the article](https://ieeexplore.ieee.org/document/10539107)
